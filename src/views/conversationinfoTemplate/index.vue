...
import { Search, View, Grid, Document, Calendar, User, Phone, Select, EditPen } from '@element-plus/icons-vue'
...
const handleSave = async () => {
  ...
  try {
    ...
    if (isEditMode.value) {
      ...
      await posttemplateInfo(templateData)
    } else {
      // 新增模式
      await posttemplateInfo(templateData)
    }
